...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			for (Marker earthquake : quakeMarkers) {
				...
				if (em.isOnLand) {
				if (cm.getProperty("name").equals(earthquake.getProperty("country"))) {
					counter +=1;
				}
				}
			}
	...
	private void printQuakesOcean () {
		...
		System.out.println("The number of earthquakes in the ocean is " + counting);	
	}
